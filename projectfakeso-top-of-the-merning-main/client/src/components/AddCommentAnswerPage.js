...
export default class AddCommentAnswerPage extends React.Component {
    constructor(props) {
        super(props);
            ...
            <div className="centered-div">
                <div className="question-section">
                    <div className="post-question-answer-container">
                        ...
                        <button className="post-question-answer-button" onClick={this.handlePostCommentAnswerClick}>Post Answer Comment</button>
                    </div>
                </div>
